...
class LoginScreenState extends State<LoginScreen> {
                    ...
                    listener: (context, state) {
                      ...
                      if (state is VerifyOtpSuccess) {
                        if (widget.isDeleteAccount ?? false) {
                          ...
                          if (state.credential.user!.phoneNumber != null) {
    ...
    return Padding(
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            Center(child: Text(UiUtils.getTranslatedLabel(context, "or"))),
            SizedBox(
              height: 20.rh(context),
            ),
  ...
  Future<void> signWithGoogle() async {
    print('dbg login screen');
    // if (widget.isDeleteAccount ?? false) {
    context.read<VerifyOtpCubit>().signWithGoogle();
    // }
  }
  ...
  Widget buildGoogleButton(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 0),
      child: buildSignWithGoogleButton(
        context,
        buttonTitle: UiUtils.getTranslatedLabel(context, "Google Sign-In"),
        onPressed: () {
          signWithGoogle();
        },
      ),
  ...
  Widget buildSignWithGoogleButton(BuildContext context,
      {double? height,
      double? width,
      required VoidCallback onPressed,
      bool? disabled,
